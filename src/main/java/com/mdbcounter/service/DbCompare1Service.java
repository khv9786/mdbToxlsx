...
import com.mdbcounter.service.dto.ComparisonResult;
import com.mdbcounter.service.dto.CompareCntInfo;
import com.mdbcounter.service.dto.MissingKeyInfo;
import com.mdbcounter.service.dto.MissingTableInfo;
...
public class DbCompare1Service {

    private static final Logger log = LoggerFactory.getLogger(DbCompare1Service.class);
    ...
    public DbCompare1Service(DbDao dbDao, DbComparisonDao dbComparisonDao) {
    ...
    private ComparisonResult buildComparisonResult(List<MdbTableInfo> mdbTableInfos,
        ...
        return new ComparisonResult(missingTables, missingKeys, compareCnt);
    }
